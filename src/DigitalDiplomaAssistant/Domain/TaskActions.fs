...
module TaskActions = 
    ...
    let saveCommentFile: string -> SaveCommentFileToStorage = 
        fun folderPath taskId fileName file -> 
    ...
    let updateTaskByNewStatus: GetPersonByRole -> UpdateTaskByNewStatus = 
        fun getPersonByRole task status ->
            match status with 
    ...
    let createTaskWithAvaliableStatuses: CreateTaskWithAvaliableStatuses =
        fun task ->
